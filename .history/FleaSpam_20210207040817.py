...
def pressKey(_, duration_press_sec):
    win32gui.SendMessage(win32gui.FindWindow(None, "EscapeFromTarkov"), win32con.WM_KEYDOWN, win32con.VK_F5, 0)
    time.sleep(duration_press_sec)
    win32gui.SendMessage(win32gui.FindWindow(None, "EscapeFromTarkov"), win32con.WM_KEYUP, win32con.VK_F5, 0)
