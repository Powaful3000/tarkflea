...
def fasterScreenshot():
    return d.screenshot(region=(tarkPos[0],tarkPos[1],tarkPos[0]+tarkSize[0],tarkPos[1]+tarkSize[1]))

def fasterScreenshot2():
    return PIL.ImageGrab.grab(region=(tarkPos[0],tarkPos[1]))
...
def locateImage(file_loc, nickname, acc=0.9, callback=None):
    ...
    #img = fasterScreenshot()
    img = fasterScreenshot2()
